...
We plot the milage for automatic and non-automatic cars.
...
There is a significant negative effect of automatic on milage. We redo the estimation using Two-Stage Least Squares (TSLS), using weight (**wt**) as an instrument for automatic.
...
This coefficient is even more negative, and even more significant. We finally plot the residuals for both estimations.
